...
class Bkforms {
	...
	public function nullifyMembershipEndDate($companyId) {
		$this->pdo = Yii::app()->db->getPdoInstance();
	...
	public function setMembershipEndDate($companyId) {
		$this->pdo = Yii::app()->db->getPdoInstance();
	...
	public function updateMembershipStartDate($companyId) {
		$this->pdo = Yii::app()->db->getPdoInstance();
	...
	public function updateCompanyIKTRingenInformation($companyId, $relevance, $dateContacted) {
		$this->pdo = Yii::app()->db->getPdoInstance();
	...
	public function updateInvoiceInformation($companyId, $invoicecontact, $organizationnumber, $invoiceaddress, $membershipfee) {
		$this->pdo = Yii::app()->db->getPdoInstance();
