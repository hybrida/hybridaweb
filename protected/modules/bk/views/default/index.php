...
<p>
    ...
    <ul>
        ...
        <li>Alumnistudenter har ingen mulighet til å velge bedrifter som ikke finnes i databasen. Hvis en alumnistudent er blitt ansatt i en bedrift som
        ikke er i databasen, er det medlemmer av <?= $this->title ?> som har ansvar for å legge til denne bedriften og linke studenten til denne.</li>
        ...
        Alle bedriftspresentasjoner vil uansett publiseres under <b>Presentasjoner</b>, men kun presentasjoner med bedriftsnavn som tilsvarer et bedriftsnavn
        vi har i databasen vil kunne linkes til en bedrift.</li>
    </ul>
</p>
<p>
